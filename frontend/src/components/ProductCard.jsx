...
function ProductCard({ _id="", imgUrl, name="", brand="", rating="", discount="", price="", sellingPrice="" }) {
    ...
    return (
    <>
    <div className="w-60 bg-slate-00 rounded-md bg-white hover:shadow-lg cursor-pointer transition-all relative group select-none">
        <span 
