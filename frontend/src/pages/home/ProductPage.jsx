                ...
                <div className="w-[60%] h-[85vh] bg-white rounded-md border overflow-y-auto hiddenScrollBar">
                    <div className="px-8 py-6 flex flex-col gap-3">
                        <h2 className="text-2xl font-semibold">
                            {product?.name} <span className="text-lg text-gray-500 font-medium">({product?.brand})</span>
                        </h2>
                        ...
                        <p>
                            <span className="flex items-center gap-1 text-gray-500">
                                ...
                                <span className="text-green-500 font-medium flex items-center gap-1">
                                    <BsCurrencyRupee /> {product?.price - product?.sellingPrice}
                                </span>
                                on this Product
                            </span>
                        </p>
                                            ...
                                            <ul className="flex flex-col gap-4">
                                                {
                                                    ...
                                                    <li>
                                                        ...
                                                        <p className="mt-2 text-gray-400 font-medium flex gap-2">
                                                            <span>
                                                            {
