            ...
            isLoading ? (
                <>
                    <div className="flex flex-col md:flex-row items-center gap-2">
                        <div className="w-full md:w-[40%] md:h-[85vh] bg-white rounded-md border">
                            <div className="flex flex-col-reverse md:flex-row items-center gap-2 p-2">
                                <div className='w-full md:w-[40%] md:h-[70vh] overflow-y-auto bg-slate-50 rounded-md'>
                                    <div className="flex flex-row md:flex-col items-center justify-center gap-2 py-2">
                                        <p className="sm:w-24 lg:w-32 md:h-24 p-2 rounded-sm bg-slate-200 animate-pulse"></p>
                                        <p className="sm:w-24 lg:w-32 md:h-24 p-2 rounded-sm bg-slate-200 animate-pulse"></p>
                                        <p className="sm:w-24 lg:w-32 md:h-24 p-2 rounded-sm bg-slate-200 animate-pulse"></p>
                                        <p className="sm:w-24 lg:w-32 md:h-24 p-2 rounded-sm bg-slate-200 animate-pulse"></p>
                                ...
                                <div className='w-full md:w-[60%] md:h-[70vh] flex items-center justify-center relative'>
                        ...
                        <div className="w-full md:w-[60%] md:h-[85vh] bg-white rounded-md border overflow-y-auto hiddenScrollBar">
                ...
                product ? (
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-2">
                        <div className="w-full sm:w-[40%] sm:h-[85vh] bg-white rounded-md border">
                            <div className="flex flex-col-reverse sm:flex-row items-center gap-2 p-2">
                                <div className='w-full sm:w-[40%] sm:h-[65vh] lg:w-[30%] lg:h-[70vh] overflow-y-auto overflow-x-auto bg-slate-50 rounded-md'>
                                    <div className="min-w-fit h-[8rem] sm:w-auto sm:h-auto flex flex-row sm:flex-col sm:items-center sm:justify-center gap-2 py-2">
                                        {
                                            imagePreviews.map((preview, index) => (
                                                <div key={index} className="bg-white rounded-lg relative group w-[10rem] sm:w-24 sm:h-24 p-1 border-2 cursor-pointer hover:border-blue-500"
                                                title="Preview image"
                                                >
                                                    <img
                                                        src={preview.url}
                                ...
                                <div className='sm:w-[60%] sm:h-full lg:w-[70%] lg:h-[70vh] flex items-center justify-center relative'>
                                    <div className='w-[280px] sm:w-[350px] h-[250px] sm:h-[350px] p-2 flex items-center justify-center'>
                            ...
                            
                            {
                                isAuthenticated && (
                                    <div className='bg-slate-00 p-2 flex items-center justify-around'>
                                        ...
                                        className="bg-yellow-400 text-sm lg:text-base text-white font-bold rounded-md hover:opacity-85 px-4 py-2 lg:px-10 lg:py-3 flex items-center gap-2"
                                        >
                                            <FaCartShopping /> ADD TO CART 
                                        </button>

                                        <button
                                        className="bg-orange-500 text-sm lg:text-base text-white font-bold rounded-md hover:opacity-85 px-4 py-2 lg:px-10 lg:py-3 flex items-center gap-2"
                                        >
                        ...
                        <div className="sm:w-[60%] sm:h-[85vh] bg-white rounded-md border overflow-y-auto hiddenScrollBar">
                            <div className="px-2 sm:px-4 lg:px-8 py-3 lg:py-6 flex flex-col gap-1.5 lg:gap-3">
                                <h2 className="text-lg lg:text-2xl font-semibold">
                                    {product?.name} <span className="text-base lg:text-lg text-gray-500 font-medium uppercase">({product?.brand})</span>
                                </h2>
                                ...
                                <p className="text-sm lg:text-base flex items-center gap-2 text-gray-600 font-medium">
                                ...
                                <p className="text-xs lg:text-sm bg-orange-500 text-white font-mono italic w-fit px-2 lg:py-0.5 rounded-full">
                                    <span className="text-sm font-extrabold">Sk</span> Assured Product
                                </p>

                                <p className="flex items-center gap-2 mt-2 tracking-wide">
                                    <span className="flex items-center text-xl lg:text-3xl font-bold">
                                        ₹{product?.sellingPrice}
                                    </span>
                                    <span className="flex items-center text-gray-700 text-sm lg:text-xl line-through">
                                        ₹{product?.price}
                                    </span>
                                </p>
                                ...
                                <div>
                                    <h4 className="text-base lg:text-xl font-semibold">Available Offers</h4>

                                    <ul className="flex flex-col gap-3 text-sm lg:text-base mt-2">
                                        {
                                            offers.map((element, index) => (
                                                <li 
                                                key={index}
                                                className="flex flex-col lg:flex-row lg:items-center gap-0.5 lg:gap-2"> 
                                ...
                                <div>
                                    <h4 className="text-base lg:text-xl font-semibold">Product Description</h4>
                                        ...
                                        <ul className="flex flex-col gap-3 mt-2">
                                        {
                                            product?.attributes ? (
                                                ...
                                                Object.entries(product?.attributes)?.map(([key, value]) => (
                                                    <li key={uuidv4()} className="text-sm lg:text-base flex items-center gap-2">
                                ...
                                <div>
                                    ...
                                    <div className="flex flex-col gap-3 mt-2">
                                        <h5 className="text-base lg:text-lg">What makes a good review</h5>

                                        <h6 className="text-[14px] lg:text-base">Have you used this product?</h6>
                                        <p className="text-sm lg:text-base text-gray-500">Your review should be about your experience with the product.</p>

                                        <h6 className="text-[14px] lg:text-base">Why review a product?</h6>
                                        <p className="text-sm lg:text-base text-gray-500">Your valuable feedback will help fellow shoppers decide!</p>

                                        <h6 className="text-[14px] lg:text-base">How will the reviewer feel after reading your review?</h6>
                                        <p className="text-sm lg:text-base text-gray-500">The reviewer should feel appreciated and valued.</p>
                                    </div>

                                    <button 
                                    onClick={() => setRateProductBtn((prev) => !prev)}
                                    className="text-sm lg:text-base bg-slate-100 hover:bg-slate-200 font-medium px-4 py-2 rounded-md mt-4 flex items-center gap-2">
                                        Rate Product <IoStar />
                                    </button>
                                    ...
                                    rateProductBtn && (
                                        isAuthenticated ? (
                                            ...
                                            >
                                                <h2 className="text-base lg:text-lg font-medium">Rate this product</h2>
                                                <div className="my-2">
                                                    <div className="text-lg lg:text-3xl text-slate-400 flex items-center gap-4">
                                                ...
                                                <h2 className="text-base lg:text-lg font-medium">Review this product</h2>
                                                <div className="text-sm lg:text-base flex flex-col gap-2 mt-2">
                                                    ...
                                                    <button className="text-sm lg:text-lg text-white bg-orange-500 hover:bg-orange-400 w-fit px-4 py-1 rounded-md">Submit</button>
                                                </div>
                                            </form>
                                            </div>
                                        ) : (
                                            <div>
                                                <p className="text-sm lg:text-lg text-center text-gray-600 hover:text-orange-500 cursor-default">Please login to rate the product.</p>
                                            </div>
                                        )
                                    )
                                    }
                                ...
                                <div>
                                    <h4 className="text-base lg:text-xl font-semibold my-3">Product Buyer Reviews</h4>
                                    ...
                                    <div>
                                        {
                                            !isLoading ? (
                                                productReviews?.length > 0 ? (
                                                    <ul className="flex flex-col gap-4">
                                                        {
                                                            ...
                                                            <li key={uuidv4()}>
                                                                <p className="flex items-center gap-2">
                                                                    <p
                                                                    className="flex items-center gap-1 px-2 py-0 text-xs lg:text-sm font-medium text-white bg-green-500 rounded-md">
                                                                ...
                                                                <p
                                                                className="mt-2 text-sm lg:text-base text-gray-800"
                                                                >
                                                                    {review?.description}
                                                                </p>
                                                                <p className="mt-2 text-sm lg:text-base text-gray-400 font-medium flex gap-2 cursor-default">
                                                    ...
                                                    <p className="text-base lg:text-lg text-center text-gray-600 hover:text-orange-500 cursor-default">Product not reviewed yet.</p>
                                                )
                                            ) : (
                                                <MiniLoading />
                                            )
                    ...
                    <div className="container mx-auto my-2">
                        {
                            product?.category ? (
                                ...
                                <div className="bg-white p-2 my-2 rounded-md">
                                    <h2 className="text-base lg:text-xl font-medium">Recommended Similar Products</h2>
